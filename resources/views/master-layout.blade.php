...
<head>
    ...
    {{-- custom stylesheet for pagination --}}
                        ...
                        <div class="right-content">
                            <ul class="list-main">
                                ...
                                @if (Route::has('login'))
                                    ...
                                    @auth
                                        <li><i class="ti-user"></i> {{ Auth::user()->name }}
                                        </li>
                                    ...
                                    @else
                                        ...
                                        @if (Route::has('register'))
                                            <li><i class="ti-user"></i> <a href="{{ route('register') }}">Register</a>
                                                </li>
                                        @endif
                                    @endauth
                    ...
                    <div class="col-lg-2 col-md-3 col-12">
                        <div class="right-bar">
                            ...
                            <div class="sinlge-bar shopping">
                                <i class="ti-bag"></i><span class="cart-count">
                                ...
                                <div class="shopping-item">
                                    ...
                                    <ul class="shopping-list">
                                        @foreach (Cart::content() as $product)
                                            <li>
                                                ...
                                                <img class="cart-img" style="max-height: 50px; max-width: 50px;"
                                                ...
                                                <p class="quantity">1x - <span class="amount">Rs.
                                                        {{ $product->model->price }}</span></p>
                                            </li>
                                        @endforeach
                                    ...
                                    <div class="bottom">
                                        <div class="total">
                                            <span>Total</span>
                                            <span class="total-amount">Rs. {{ Cart::total() }}</span>
                                        </div>
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-6 col-12">
                        ...
                        <div class="single-footer about">
                            <div class="logo">
                                <a href="{{ route('home') }}"><img src="images/logo2.png" alt="#"></a>
                            </div>
